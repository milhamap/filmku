                                                        ...
                                                        <div class="py-6 px-6 lg:px-8">
                                                            <form @submit.prevent="createTransaction">
                                                                ...
                                                                <div class="flex flex-col">
                                                                    ...
                                                                    <input type="text" id="title" v-bind:value="movie.film.title" class="border border-gray-300 p-2 rounded-lg mt-1 focus:outline-none focus:border-indigo-500" v-model="title">
                                                                </div>
                                                                <div class="flex flex-col">
                                                                    <label class="text-dark" for="description">Description</label>
                                                                    <input type="text" v-bind:value="movie.film.description" id="description" class="border border-gray-300 p-2 rounded-lg mt-1 focus:outline-none focus:border-indigo-500" v-model="description">
                                                                </div>
                                                                <div class="row">
                                                                    <div class="flex flex-col col-6">
                                                                        <label class="text-dark" for="price">Price</label>
                                                                        <input type="number" v-bind:value="movie.film.price" id="price" class="border border-gray-300 p-2 rounded-lg mt-1 focus:outline-none focus:border-indigo-500" v-model="price">
                                                                    </div>
                                                                    <div class="flex flex-col col-6">
                                                                        <label class="text-dark" for="duration">Duration</label>
                                                                        <input type="number" v-bind:value="formatDuration(movie.film.duration)" id="duration" class="border border-gray-300 p-2 rounded-lg mt-1 focus:outline-none focus:border-indigo-500" v-model="duration">
                                                                    </div>
                                                                    <div class="flex flex-col col-6">
                                                                    ...
                                                                    <div class="flex flex-col col-6">
                                                                        ...
                                                                        <select v-model="room_id" id="room_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 font-bold text-center text-uppercase block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 mt-1">
                                                                    ...
                                                                    <div class="flex flex-col col-6">
                                                                        ...
                                                                        <input type="text" v-bind:value="formatActor(movie.film.actors)" id="actors" class="border border-gray-300 p-2 rounded-lg mt-1 focus:outline-none focus:border-indigo-500" v-model="actors">
                                                                    </div>
                                                                    <div class="flex flex-col col-6">
                                                                        <label class="text-dark" for="release_date">Release Date</label>
                                                                        <input v-model="release_date" v-bind:value="new Date(movie.film.release_date).toLocaleDateString()" id="release_date" type="date" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Select date">
                                                                    </div>
                                                                    <div class="flex flex-col col-6">
                                                                        <label class="text-dark" for="expire_date">Expire Date</label>
                                                                        <input v-model="expire_date" v-bind:value="new Date(movie.film.expire_date).toLocaleDateString()" id="expire_date" type="date" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Select date">
                                                                    </div>
                                                                </div>
