        ...
        <div class="ml-[410px] pr-[50px] overflow-hidden">
            <div class="py-[70px] flex flex-col gap-[50px]">
                ...
                <div class="text-end text-white">
                    <router-link :to="{name: 'RoomBioskop.Create'}" class="btn btn-outline-warning">Add Room</router-link>
                </div>
                        ...
                        <div class="py-4 inline-block w-full sm:px-6 lg:px-8">
                            <div class="overflow-hidden rounded-lg">
                                <table class="w-full text-center">
                                    ...
                                    <tbody>
                                        <tr v-for="(room, index) in rooms" :key="index" class="bg-gray-300 border-b">
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{{index+1}}</td>
                                            <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                                {{room.name}}
                                            </td>
                                            <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                                {{formatChair(room.default_chairs)}}
                                            </td>
                                            <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                                <router-link :to="{name: 'RoomBioskop.Edit', params: {id: room.random}}" class="btn btn-outline-primary">Edit</router-link>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
